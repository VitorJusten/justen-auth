...
public class UserCredentialService {
	...
	public List<UserCredential> editAll(List<UserCredential> userCredentials) {
		...
		for (UserCredential paramCredential : userCredentials) {
			...
			BeanUtils.copyProperties(paramCredential, credential, "id", "user");
			credential.setUser(getUserReference(userId));
	...
	public UserCredential findById(UUID id) {
		return repository.findById(id)
				.orElseThrow(() ->
						new BusinessException("UserCredential not found: " + id));
	}
